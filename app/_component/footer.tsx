						...
						<div className="col-span-2">
							...
							<div className="text-green-700">
								<div>
									...
									<Link href="https://www.ulkaa.com/stand-with-palestine" target="_blank">
										<strong>#StandWithPalestine</strong>
									</Link>
								</div>
								<div>
									<svg id="J-K_flag" width="24" height="16" version="1.1" viewBox="0 0 900 600"
										...
										<g id="three" fill="#ffffff">
											<g id="g344" strokeWidth=".921835">
												<rect id="rect1" x="45" y="30" width="42.75" height="540" rx="0"
												      ry="0"/>
												<rect id="rect2" x="125" y="30" width="42.75" height="540" rx="0"
												      ry="0"/>
												<rect id="rect3" x="205" y="30" width="42.75" height="540" rx="0"
												      ry="0"/>
											</g>
											<path id="path1"
									...
									<Link href="https://www.ulkaa.com/stand-with-kashmir" target="_blank">
										<strong>#StandWithKashmir</strong>
									</Link>
								</div>
							</div>
						</div>
