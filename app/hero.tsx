...
export default function Hero(): JSX.Element {
	return (
		<>
			{/*<ParticleAnimation/>*/ }
			{ /* Animated hero component for an AI company using tailwind css */ }
			<div
			...
			<div className="absolute inset-0 h-full w-full bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30">
					...
					<div className="pt-32 pb-12 md:pt-40 md:pb-20">
						<div className="max-w-4xl mx-auto text-center">
							<h1
								...
								<span
									className="block bg-indigo-600 text-white xl:inline">
							...
							<p className="mt-3 text-base text-gray-900 sm:mt-5 sm:text-xl lg:text-2xl">
								<strong>
									We are a team of AI experts, software engineers, and business professionals who are
									passionate about building AI solutions for businesses.
								</strong>
							</p>
							<div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
								<div
									...
									<a href="#"
									   className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-gray-800 bg-white hover:bg-gray-200 sm:px-8">
										Develop Software
									</a>
								</div>
							</div>
						...
						<div className="hidden md:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-10">
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide domain registration service for your business.
								</p>
								<div className="mt-6">
									<Link href="/domain"
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide hosting service for your business.
								</p>
								<div className="mt-6">
									<Link href="/hosting"
									      className="block button w-full bg-purple-600 text-white text-center font-bold py-2 px-4 rounded hover:bg-purple-700 focus:outline-none focus:bg-indigo-700">
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide software development service for your business.
								</p>
								<div className="mt-6">
									<Link href="/software"
									      className="block button w-full bg-purple-600 text-white text-center font-bold py-2 px-4 rounded hover:bg-purple-700 focus:outline-none focus:bg-indigo-700">
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide AI service for your business.
								</p>
								<div className="mt-6">
									<Link href="/ai"
									      className="block button w-full bg-purple-600 text-white text-center font-bold py-2 px-4 rounded hover:bg-purple-700 focus:outline-none focus:bg-indigo-700">
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide SEO service for your business.
								</p>
								<div className="mt-6">
									<Link href="/seo"
									      className="block button w-full bg-purple-600 text-white text-center font-bold py-2 px-4 rounded hover:bg-purple-700 focus:outline-none focus:bg-indigo-700">
							...
							<div
								...
								<p className="mt-4 text-center text-gray-800">
									We provide marketing service for your business.
								</p>
								<div className="mt-6">
									<Link href="/marketing"
									      className="block button w-full bg-purple-600 text-white text-center font-bold py-2 px-4 rounded hover:bg-purple-700 focus:outline-none focus:bg-indigo-700">
