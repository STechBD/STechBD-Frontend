...
export const pricingData: Pricing[] = [
	...
	},
	{
		...
		features: [
			<><strong>1</strong> CMS Website with Blog</>,
			<><strong>Meta Pixel</strong> Setup</>,
			<><strong>Google Analytics</strong> Setup</>,
			<><strong>5GB NVMe SSD</strong> Storage</>,
			<><strong>100GB</strong> Bandwidth</>,
			<><strong>1</strong> Domain</>,
			<><strong>Unlimited</strong> Subdomain and Parked Domain</>,
	...
	{
		title: 'School and Education Website',
		featured: true,
		price: {
			bdt: 15000,
			usd: 150,
		...
		period: 0,
		description: 'Ideal for small scale school and education website',
		features: [
			<><strong>1</strong> CMS Website with Blog</>,
			<><strong>Dedicated Pages</strong> for School</>,
			<><strong>5GB NVMe SSD</strong> Storage</>,
			<><strong>100GB</strong> Bandwidth</>,
			<><strong>1</strong> Domain</>,
			<><strong>Unlimited</strong> Subdomain and Parked Domain</>,
