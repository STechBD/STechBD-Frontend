			...
			<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
				{
					data.map((item: any, index: number): JSX.Element => {
						return (
							<div
								key={ index }
								className="p-8 bg-white rounded-lg shadow-md hover:shadow-xl dark:bg-gray-800 dark:border dark:border-gray-700 dark:hover:border-gray-600 dark:hover:shadow-lg dark:shadow-sm"
							>
