				...
				<div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 lg:grid-cols-6">
					<div className="col-span-2 mb-6 grid grid-cols-3 justify-center">
						<div className="flext justify-end">
							<Bounce hover={ true }>
								<AnimatedLogo className="h-24 w-24 md:h-28 md:w-28 lg:h-40 lg:w-40"/>
							</Bounce>
						</div>
						<div className="col-span-2">
							...
							<div className="mb-3 text-justify text-gray-700 dark:text-gray-300">
							...
							<div className="text-green-700">
								<div className="flex items-center">
									<svg
										xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 6 3"
								...
								<div className="flex items-center">
									<svg
										width="24" height="16" version="1.1" viewBox="0 0 900 600"
					...
					{ config.footer.menu.map((section, index: number): JSX.Element | null => {
				...
				<div className="px-4 py-6 md:flex md:items-center md:justify-between">
					...
					<div className="social flex mt-4 space-x-5 justify-center lg:mt-0 lg:justify-end">
						<Link href="https://www.facebook.com/STechBD.Net" target="_blank" className="text-gray-700">
							<svg
								className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
						...
						<Link href="https://www.linkedin.com/in/STechBD" target="_blank" className="text-gray-700">
							<svg
								fill="currentColor" className="w-4 h-4" viewBox="0 0 16 16"
						...
						<Link href="https://www.x.com/STechBD_Net" target="_blank" className="text-gray-700">
							<svg
								className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
								viewBox="0 0 16 16"
							>
								<path
